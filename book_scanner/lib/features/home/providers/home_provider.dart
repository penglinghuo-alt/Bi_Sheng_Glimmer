...
class HomeNotifier extends StateNotifier<HomeState> {
  ...
  // 初始化日志 — 延迟按实际时间戳差值（归零各 8s 不砍半保留真实感）
  // [15s→15s] 同日戳: 300ms
  // [15s→20s] 实际 5s: 5000ms
  // [20s→23s] 实际 3s: 3000ms
  // [23s→28s] 实际 5s: 5000ms
  // [28s→31s] 实际 3s: 3000ms
  // Y 归零 8s + X 归零 8s = 16s
  static const _initLogs = [
    ...
    _LogEntry('[2026-07-03 19:46:15][INFO][init] [MOTOR-HOME] 开始Y1/Y2同步回零，目标最小时长=8.0s', 5000),
    _LogEntry('[2026-07-03 19:46:20][INFO][init] [MOTOR-HOME] 回零实际执行4.891s，小于配置8.000s，补足等待3.109s', 3000),
    ...
    _LogEntry('[2026-07-03 19:46:23][INFO][init] [MOTOR-HOME] 开始X轴回零，目标最小时长=8.0s', 5000),
    _LogEntry('[2026-07-03 19:46:28][INFO][init] [MOTOR-HOME] 回零实际执行4.897s，小于配置8.000s，补足等待3.103s', 3000),
  ...
  // 工作日志 — 延迟按实际处理量估算，OCR/转换/打印环节加重延时
  static const _workLogs = [
    _LogEntry('[19:46:35][INFO][scanner] 纸张传感器触发，检测到纸张', 800),
    _LogEntry('[19:46:36][INFO][scanner] 纸张厚度: 0.12mm, 材质: 盲文专用纸', 500),
    _LogEntry('[19:46:37][INFO][scanner] 开始翻页...', 1500),
    _LogEntry('[19:46:38][INFO][scanner] 翻页完成，步进电机到位', 800),
    _LogEntry('[19:46:38][INFO][camera] 摄像头初始化...', 600),
    _LogEntry('[19:46:39][INFO][camera] 正在拍摄图像...', 2000),
    _LogEntry('[19:46:40][INFO][camera] 图像采集完成，分辨率 2048x1536, 300DPI', 800),
    _LogEntry('[19:46:41][INFO][camera] 图像预处理：去噪、二值化、倾斜校正', 2000),
    _LogEntry('[19:46:42][INFO][camera] 预处理完成', 500),
    _LogEntry('', 2000),
    _LogEntry('[19:46:43][INFO][ocr] 开始 OCR 文字识别...', 600),
    _LogEntry('[19:46:44][INFO][ocr] 加载识别模型: chinese_ocr_v3.pth', 2000),
    _LogEntry('[19:46:45][INFO][ocr] 模型加载完成，推理引擎: ONNX Runtime', 500),
    _LogEntry('[19:46:45][INFO][ocr] 文字区域检测中...', 1500),
    _LogEntry('[19:46:46][INFO][ocr] 检测到 12 个文字区域', 500),
    _LogEntry('[19:46:46][INFO][ocr] 逐区域字符识别中...', 2500),
    _LogEntry('[19:46:48][INFO][ocr] 区域 1-4 识别完成 (进度: 33.3%)', 1500),
    _LogEntry('[19:46:49][INFO][ocr] 区域 5-8 识别完成 (进度: 66.7%)', 1500),
    _LogEntry('[19:46:50][INFO][ocr] 区域 9-12 识别完成 (进度: 100.0%)', 800),
    _LogEntry('[19:46:50][INFO][ocr] OCR 识别完成，共检测 248 个字符', 800),
    _LogEntry('[19:46:50][INFO][ocr] 识别置信度: 97.3%', 500),
    _LogEntry('', 2500),
    _LogEntry('[19:46:52][INFO][converter] 开始盲文点阵转换...', 600),
    _LogEntry('[19:46:52][INFO][converter] 加载盲文对照表: braille_table_v2.json', 1500),
    _LogEntry('[19:46:53][INFO][converter] 文本分段处理中...', 800),
    _LogEntry('[19:46:53][INFO][converter] 共 3 个段落，逐段转换', 400),
    _LogEntry('[19:46:54][INFO][converter] 第 1 段落转换完成 (40 字符)', 1500),
    _LogEntry('[19:46:55][INFO][converter] 第 2 段落转换完成 (82 字符)', 1500),
    _LogEntry('[19:46:56][INFO][converter] 第 3 段落转换完成 (126 字符)', 1500),
    _LogEntry('[19:46:57][INFO][converter] 点阵映射完成: 40x30', 600),
    _LogEntry('[19:46:57][INFO][converter] 盲文转换完成，开始传输数据', 1000),
    _LogEntry('', 2000),
    _LogEntry('[19:46:58][INFO][printer] 打印头预热中...', 600),
    _LogEntry('[19:46:59][INFO][printer] 打印头温度: 45.2°C / 目标 80.0°C', 1500),
    _LogEntry('[19:47:00][INFO][printer] 打印头温度: 62.7°C / 目标 80.0°C', 1500),
    _LogEntry('[19:47:01][INFO][printer] 打印头温度: 78.3°C，预热完成', 1000),
    _LogEntry('[19:47:01][INFO][printer] 开始打印，总行数: 30', 600),
    _LogEntry('[19:47:02][INFO][printer] 打印行 1-5 (进度: 16.7%)', 1200),
    _LogEntry('[19:47:03][INFO][printer] 打印行 6-10 (进度: 33.3%)', 1200),
    _LogEntry('[19:47:04][INFO][printer] 打印行 11-15 (进度: 50.0%)', 1200),
    _LogEntry('[19:47:05][INFO][printer] 打印行 16-20 (进度: 66.7%)', 1200),
    _LogEntry('[19:47:05][INFO][printer] 打印行 21-25 (进度: 83.3%)', 1200),
    _LogEntry('[19:47:06][INFO][printer] 打印行 26-30 (进度: 100.0%)', 1200),
    _LogEntry('[19:47:07][INFO][printer] 打印完成', 800),
    _LogEntry('[19:47:07][INFO][scanner] 纸张传送中...', 1500),
    _LogEntry('[19:47:08][INFO][scanner] 机械臂归位', 1000),
    _LogEntry('[19:47:09][INFO][main] --- 打印任务全部完成 ---', 800),
  ];
